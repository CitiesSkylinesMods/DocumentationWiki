Our CI (Continuous Integration) process, which runs automatically for all PRs (Pull Requests), compiles a packaged .zip file of the mod with the updates associated with the PR.
